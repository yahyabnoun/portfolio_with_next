...
export default function Home() {
  ...
  let dataWebsite = {
    ...
    // boxShadow : ["10px 10px 19px #1c1e22, -10px -10px 19px #262a2e","-10px -10px 19px 0px #cecece, 10px 10px 19px 0px #dad9d9"]
  }
  ...
  return (
    ...
    <>
      ...
      <main className='container_all' data-bs-theme={darkMode ? 'dark' : 'light'} style={{ backgroundColor: darkMode ? '#212428' : '', color: darkMode ? 'white' : '#212121' }} >
        <button title='buttondarkmode' className='buttondarkmode' onClick={() => { setdarkMode(!darkMode) }}>
          ...
          <div className='introduce-div skills   mx-auto '>
            <div className='introduce-div-finfMe  '>
              ...
              <div className=' d-flex justify-content-around '>
                <Link aria-label='link to github'  className={`Box_Link ${darkMode ? "boxShadowdark" : "boxShadowwhite"}`}  target="_blank" href={"https://github.com/yahyabnoun"}>
                ...
                <Link aria-label='link to Linldin' className={`Box_Link ${darkMode ? "boxShadowdark" : "boxShadowwhite"}`} target="_blank" href={"https://www.linkedin.com/in/yahyabnoun/"}>
                ...
                <Link aria-label='link to email' className={`Box_Link ${darkMode ? "boxShadowdark" : "boxShadowwhite"}`} href={"#section3"}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 49.4 512 399.4200000000001"><g fillRule="evenodd"><g fillRule="nonzero"><path d="M34.91 448.818h81.454V251L0 163.727V413.91c0 19.287 15.622 34.91 34.91 34.91z" /><path d="M395.636 448.818h81.455c19.287 0 34.909-15.622 34.909-34.909V163.727L395.636 251z" /><path d="M395.636 99.727V251L512 163.727v-46.545c0-43.142-49.25-67.782-83.782-41.891z" /></g><path d="M116.364 251V99.727L256 204.455 395.636 99.727V251L256 355.727z" /><path d="M0 117.182v46.545L116.364 251V99.727L83.782 75.291C49.25 49.4 0 74.04 0 117.18z" fillRule="nonzero" /></g></svg>
        ...
        <section className='s_projects'>
          ...
          <section className='section2'>
            ...
            <div className='all_card'>
              {
                dataWebsite.dataOfProjects.map((item, ind) => {
                  return (
                    <div className={`card ${darkMode ? "boxShadowdark" : "boxShadowwhite"}`} style={{boxShadow : dataWebsite.boxShadow}} key={ind}>
                      <Image
                        ...
                        <div className='div_tags'>
                          {/* <span>tags : </span> */}
                          {
                            item.tags.map((item, ind) => {
                              return (
                                <p key={ind} className="card_tag">{item}</p>
                              )
                            }
                            )
                          }
            ...
            <div className='Resume' id='Resume'>
              <div className='Education'>
                ...
                <div className='all_box'>
                  <div className={`box ${darkMode ? "boxShadowdark" : "boxShadowwhite"}`}>
